...
describe("GetDeviceTest", () => {
    it('should return matching device object', async function () {
        ...
        const firestoreDevice = new _1.FirestoreDevice('test light', devices_1.DeviceTypes.Light, userRef, new Map(Object.entries({ brightness: 92, on: true })));
        const dbDevice = await db.runTransaction(async (t) => {
            return await _1.getDevice('xCAMyLzbgisor8kxM21W', t);
        });

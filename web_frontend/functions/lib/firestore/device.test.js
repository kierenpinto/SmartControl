...
describe("GetDeviceTest", () => {
    it('should return matching device object', async function () {
        ...
        const firestoreDevice = new device_1.FirestoreDevice('test light', 'light', userRef, new Map(Object.entries({ brightness: 92, on: true })));
        const dbDevice = await db.runTransaction(async (t) => {
            return await device_1.getDevice('xCAMyLzbgisor8kxM21W', t);
        });
